...
import htkc.ebaba.ecom.CategoryActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.MyviewHolder>
{
    ...
    public void onBindViewHolder(MyviewHolder holder, int position) {
        ...
        Log.d("Complete", categoryList.get(position).getCat_name());
       // Toast.makeText(context, ""+categoryList.get(position).getCat_name(), Toast.LENGTH_SHORT).show();
