    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rsend.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String mobile = SharedPrefManager.getInstance(VerificationActivity.this).verifyNo().getMobile();
                mProgress.show();
                ...
                call1.enqueue( new Callback<ResendResponse>() {
                    ...
                    public void onResponse(Call<ResendResponse> call, Response<ResendResponse> response) {
                        if(!response.body().getError()) {
                            ...
                            mProgress.dismiss();
                            Toast.makeText( VerificationActivity.this, "Please Check Your Inbox...!", Toast.LENGTH_LONG ).show();

                        }
                        else{
                            mProgress.dismiss();
                            Toast.makeText( VerificationActivity.this, "Please Check Your Internet Connection...!", Toast.LENGTH_LONG ).show();
                    ...
                    public void onFailure(Call<ResendResponse> call, Throwable t) {
                        mProgress.dismiss();
                        Toast.makeText( VerificationActivity.this, "Connection Failed...!", Toast.LENGTH_LONG ).show();
                ...
                call.enqueue( new Callback<VerifyResponse>() {
                    ...
                    public void onResponse(Call<VerifyResponse> call, Response<VerifyResponse> response) {
                        if(!response.body().getError()) {
                            ...
                            SharedPrefManager.getInstance( VerificationActivity.this ).userLogin( muname, mmobile, mid );

                            mProgress.dismiss();
                            Toast.makeText( VerificationActivity.this, "Successfully Loged In...!", Toast.LENGTH_LONG ).show();
                            startActivity( new Intent( VerificationActivity.this, HomeActivity.class ) );
                        }
                        else{
                            mProgress.dismiss();
                            Toast.makeText( VerificationActivity.this, "Please Confirm Your OTP...!", Toast.LENGTH_LONG ).show();
...
/*        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            Toast.makeText(VerificationActivity.this, item.getTitle(), Toast.LENGTH_SHORT).show();
        }
