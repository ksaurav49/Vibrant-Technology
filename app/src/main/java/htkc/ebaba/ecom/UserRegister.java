...
public class UserRegister extends AppCompatActivity {
    ...
    public TextInputEditText user,password,phone;
                ...
                call.enqueue( new Callback<RegisterResponse>() {
                    ...
                    public void onResponse(Call<RegisterResponse> call, Response<RegisterResponse> response) {
                        if(!(response.body().getError())){
                            ...
                            SharedPrefManager.getInstance(UserRegister.this).userVerify(verify);

                            Snackbar.make(parent_view, "Please Verify Your Mobile No.", Snackbar.LENGTH_SHORT).show();
                            startActivity( new Intent( UserRegister.this, VerificationActivity.class ) );
                            finish();
